...
public_users.get('/axios_isbn/:isbn', async function (req, res) {
    const isbn = req.params.isbn;
  
    try {
      // Simulate an async call to fetch book details
...
public_users.get('/isbn/:isbn',function (req, res) {
 ...
 // Async-Await approach to get book details based on author
public_users.get('/axios_author/:author', async function (req, res) {
...
// Async-Await approach to get book details based on title
public_users.get('/axios_title/:title', async function (req, res) {
    const title = req.params.title;
